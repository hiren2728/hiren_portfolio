import "./AboutMe.css";
import { useGetHomeDetailsQuery, useGetAboutMeQuery } from "../../Api/dataAPI"
...
const AboutMe = () => {
  ...
  const { data: contacts1Details } = useGetHomeDetailsQuery();
            ...
            <div className="aboutMe-container">
              ...
              <div className="abouMe-row">
                ...
                >
                  ...
                  <div className="itscv">
                    <a
                      href="https://drive.google.com/file/d/1lRZ_fdBZQA4f2mgAd6TP0X_gA9_26Vgn/view?usp=sharing"
                      download="RESUME.pdf"
                      target="_blank"
